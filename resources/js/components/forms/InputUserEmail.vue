    ...
    <div :class="{'has-success': validate.show && validate.valid, 'has-error': validate.show && !validate.valid}">
        ...
        <div v-if="!is_allowed_fast_confirm && !is_email_verified" class="input-confirm-form-email" :ref="inputConfirmForm">
            <div class="input-confirm-form-email__item">
                <p class="text-green">На указанный вами email отправлено письмо с кодом активации. Перейдите по ссылке из email для активации.<br> Если этого письма нет во «Входящих», пожалуйста, проверьте «Спам».<br> При наличии нескольких писем используйте то, которое пришло последним.</p>
