...
<div class="shadow-box">
    <div class="shadow-box__title">Подтверждение email</div>
    <div class="shadow-box__content">
        <div class="error-block">
            <div class="error-block__item">Ошибка: {{ $errors->first() }}</div>
            <div class="error-block__footer">
                Если по какой-то причине у вас не получилось подтвердить email, <a href="#">свяжитесь с нами</a>, и мы сделаем все возможное что бы помочь вам.
            </div>
        </div>
    </div>
</div>
